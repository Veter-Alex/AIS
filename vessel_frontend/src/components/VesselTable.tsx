...
const VesselTable: React.FC<VesselTableProps> = ({ vessels, sortBy, sortOrder, onSort }) => {
        ...
        <tbody>
          {vessels.map((vessel) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-sm text-gray-300">{vessel.general_type}</td>
              <td className="px-4 py-3 text-sm text-gray-300">{vessel.flag}</td>
              <td className="px-4 py-3 text-sm text-gray-400">{vessel.year_built || '-'}</td>
              <td className="px-4 py-3 text-sm text-gray-400">{vessel.length || '-'}</td>
              <td className="px-4 py-3 text-sm text-gray-400">{vessel.width || '-'}</td>
              <td className="px-4 py-3 text-sm text-gray-400">{vessel.gt || '-'}</td>
              <td className="px-4 py-3 text-sm text-gray-400">{vessel.dwt || '-'}</td>
            </tr>
          ))}
        </tbody>
      </table>
